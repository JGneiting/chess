...
public class EscapeSequences {
    ...
    public static final String SET_TEXT_COLOR_LIGHT_GREY = SET_TEXT_COLOR + "245m";
    ...
    public static final String SET_TEXT_COLOR_LIGHT_BLUE = SET_TEXT_COLOR + "39m";
    public static final String SET_TEXT_COLOR_DARK_BLUE = SET_TEXT_COLOR + "33m";
    public static final String SET_TEXT_COLOR_LIGHT_PURPLE = SET_TEXT_COLOR + "135m";
    public static final String SET_TEXT_COLOR_DARK_PURPLE = SET_TEXT_COLOR + "98m";
    ...
    public static final String SET_BG_COLOR_LIGHT_BLUE = SET_BG_COLOR + "39m";
    public static final String SET_BG_COLOR_DARK_BLUE = SET_BG_COLOR + "33m";
    public static final String SET_BG_COLOR_LIGHT_PURPLE = SET_BG_COLOR + "135m";
    public static final String SET_BG_COLOR_DARK_PURPLE = SET_BG_COLOR + "98m";
