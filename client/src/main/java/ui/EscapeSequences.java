...
public class EscapeSequences {
    ...
    public static final String SET_TEXT_COLOR_LIGHT_YELLOW = SET_TEXT_COLOR + "227m";
    public static final String SET_TEXT_COLOR_DARK_YELLOW = SET_TEXT_COLOR + "226m";
    ...
    public static final String SET_BG_COLOR_LIGHT_YELLOW = SET_BG_COLOR + "227m";
