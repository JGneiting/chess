...
public class EscapeSequences {
    ...
    public static final String SET_TEXT_COLOR_LIGHT_BLUE = SET_TEXT_COLOR + "153m";
    public static final String SET_TEXT_COLOR_DARK_BLUE = SET_TEXT_COLOR + "45m";
    public static final String SET_TEXT_COLOR_LIGHT_YELLOW = SET_TEXT_COLOR + "229m";
    ...
    public static final String SET_BG_COLOR_LIGHT_BLUE = SET_BG_COLOR + "153m";
    public static final String SET_BG_COLOR_DARK_BLUE = SET_BG_COLOR + "45m";
